# --- Clash main / global ---
# (209, 555) is deadspace on BOTH clients: on the CN main menu the left/right
# columns are interactive event icons, so x=35/x=385 clicks open popups; the
# center strip just above the bottom nav is inert on both layouts.
CLASH_MAIN_DEADSPACE_COORD = (209, 555)
...
# --- CN (Tencent) client full-screen event pages (e.g. CRL 冠军之路) ---
# The bottom-left "返回" (return) button, sampled off a live CN client at 419x633.
CN_EVENT_PAGE_RETURN_BUTTON_COORD = (155, 591)
