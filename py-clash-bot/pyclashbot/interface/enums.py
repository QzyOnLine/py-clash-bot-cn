...
BATTLE_STAT_LABELS: dict[StatField, str] = {
    StatField.CARDS_PLAYED: "出牌数",
    StatField.CLASSIC_1V1_FIGHTS: "经典 1v1",
    StatField.CLASSIC_2V2_FIGHTS: "经典 2v2",
    StatField.TROPHY_ROAD_1V1_FIGHTS: "天梯对战",
    StatField.CARD_RANDOMIZATIONS: "随机卡组次数",
    StatField.CARD_CYCLES: "轮换卡组次数",
}

BATTLE_STAT_FIELDS: tuple[StatField, ...] = tuple(BATTLE_STAT_LABELS.keys())

COLLECTION_STAT_LABELS: dict[StatField, str] = {
    StatField.CARD_MASTERY_REWARD_COLLECTIONS: "卡牌精通奖励",
    StatField.UPGRADES: "升级卡牌",
    StatField.WAR_CHEST_COLLECTS: "部落战宝箱",
    StatField.CARDS_DONATED: "捐赠卡牌",
    StatField.CARD_REQUESTS: "请求卡牌",
    StatField.CLAN_GIFTS_CLAIMED: "领取礼物",
    StatField.ACCOUNT_SWITCHES: "切换账号",
}

COLLECTION_STAT_FIELDS: tuple[StatField, ...] = tuple(COLLECTION_STAT_LABELS.keys())

BOT_STAT_LABELS: dict[BotStatField, str] = {
    BotStatField.RESTARTS_AFTER_FAILURE: "故障恢复重启",
    BotStatField.TIME_SINCE_START: "运行时长",
}
